...
export class EventosComponent {
  ...
  private readonly raw: Omit<EventoF1, 'completed'>[] = [
    ...
    { round: 14, shortName: 'GP MADRID',         circuit: 'Madring',                        location: 'Madrid, España',            date: '11–13 Sep 2026',    endDate: '2026-09-13', image: 'assets/Images/madrid-track.png',      flag: 'assets/Images/spain-flag.gif'       },
    { round: 15, shortName: 'GP AZERBAIYÁN',     circuit: 'Baku City Circuit',              location: 'Bakú, Azerbaiyán',          date: '24–26 Sep 2026',    endDate: '2026-09-26', image: 'assets/Images/azerbijan-track.png',   flag: 'assets/Images/azerbaijan-flag.gif'  },
